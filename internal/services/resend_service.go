      ...
      <table width="600" cellpadding="0" cellspacing="0" style="background-color:#FFFFFF;border-radius:8px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
        ...
        <tr>
          <td style="background-color:#1D4ED8;padding:32px 40px;text-align:center;">
            <h1 style="margin:0;color:#FFFFFF;font-size:28px;font-weight:700;letter-spacing:-0.5px;">MediFlow</h1>
            <p style="margin:8px 0 0;color:#BFDBFE;font-size:13px;">PPH Clinical Decision Support</p>
          </td>
        </tr>
        ...
        <tr>
          <td style="padding:40px;">
            <p style="margin:0 0 16px;color:#1E293B;font-size:16px;">Hello <strong>%s</strong>,</p>
            ...
            <table width="100%%" cellpadding="0" cellspacing="0" style="background-color:#F8FAFC;border:1px solid #E2E8F0;border-radius:6px;margin-bottom:24px;">
              <tr>
                <td style="padding:20px 24px;">
                  <p style="margin:0 0 12px;color:#64748B;font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:0.05em;">Your Login Credentials</p>
                  <table cellpadding="0" cellspacing="0">
                    <tr>
                      <td style="padding:4px 0;color:#64748B;font-size:14px;width:100px;">Email:</td>
                      <td style="padding:4px 0;color:#1E293B;font-size:14px;font-weight:600;">%s</td>
                    </tr>
                    <tr>
                      <td style="padding:4px 0;color:#64748B;font-size:14px;">Password:</td>
                      <td style="padding:4px 0;font-size:14px;">
                        <code style="background-color:#EFF6FF;color:#1D4ED8;padding:2px 8px;border-radius:4px;font-family:monospace;font-size:14px;font-weight:700;">%s</code>
                      </td>
                    </tr>
                  </table>
                </td>
            ...
            <!-- Warning -->
            <table width="100%%" cellpadding="0" cellspacing="0" style="background-color:#FEF3C7;border:1px solid #FCD34D;border-radius:6px;margin-bottom:28px;">
              <tr>
        ...
        <tr>
          <td style="padding:40px;">
            ...
            <p style="margin:0;color:#94A3B8;font-size:13px;line-height:1.5;">
              ...
              <a href="%s" style="color:#1D4ED8;word-break:break-all;font-size:12px;">%s</a>
            </p>
          </td>
        </tr>

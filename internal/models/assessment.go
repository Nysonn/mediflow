...
type Assessment struct {
	...
	DeliveryMethodCleanForceps int       `db:"delivery_method_clean_forceps"  json:"delivery_method_clean_forceps"`
...
// CreateAssessmentInput holds the 6 model input fields provided by the clinician.
...
type CreateAssessmentInput struct {
	...
	DeliveryMethodCleanForceps int     `json:"delivery_method_clean_forceps" form:"delivery_method_clean_forceps"`

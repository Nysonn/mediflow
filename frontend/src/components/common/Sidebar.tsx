            ...
            >
              {({ isActive }) => (
                <>
                  ...
                  <span className="flex-1">Model Performance</span>
                  {!isActive && <span className="opacity-0 group-hover:opacity-100 transition-opacity"><IconChevron /></span>}
                </>
              )}
            </NavLink>
            <NavLink
            ...
            >
              {({ isActive }) => (
                <>
                  ...
                  <span className="flex-1">Batch Prediction</span>
                  {!isActive && <span className="opacity-0 group-hover:opacity-100 transition-opacity"><IconChevron /></span>}
                </>
              )}
            </NavLink>
            ...
            >
              {({ isActive }) => (
                <>
                  ...
                  <span className="flex-1">About &amp; Dataset</span>
                  {!isActive && <span className="opacity-0 group-hover:opacity-100 transition-opacity"><IconChevron /></span>}
                </>
              )}
            </NavLink>
